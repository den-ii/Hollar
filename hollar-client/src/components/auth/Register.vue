    ...
    <div v-if="!error && !result">
      <div class="" v-if="!signUpWithMail">
        ...
        >
          ...
          <span class="">Register with Google</span>
        </button> -->
        <button
      ...
      <div class="mt-6" v-else>
        <vee-form class="flex flex-col gap-3" :validation-schema="schema" @submit="register">
          ...
          <div class="w-[80%] mx-auto">
            <label for="username" class="dark:text-darks"
          ...
          <div class="w-[80%] mx-auto">
            <label for="email" class="dark:text-darks"
            ...
            <vee-field
              ...
              name="email"
              id="email"
              class="border border-gray-700 block w-full rounded p-1 focus:outline dark:text-darks focus:outline-base"
            />
            <ErrorMessage class="text-red-500 text-sm" name="email" />
          </div>
          <div class="w-[80%] mx-auto">
            <label for="Age" class="dark:text-darks"><span class="text-red-500">*</span>Age:</label>
            <vee-field
              type="number"
              name="age"
              id="age"
              class="dark:text-darks border border-gray-700 block w-full rounded p-1 focus:outline focus:outline-base"
            />
            <ErrorMessage class="text-red-500 ext-sm" name="age" />
          </div>

          <div class="w-[80%] mx-auto">
            <label for="country" class="dark:text-darks"
              ><span class="text-red-500">*</span>Country:</label
            >

            <country-select
              class="border border-gray-700 block w-full rounded py-2 focus:outline focus:outline-base dark:text-darks"
              v-model="code"
              :country="code"
              topCountry="US"
              :usei18n="false"
          ...
          <div class="w-[80%] mx-auto">
            <label for="password" class="dark:text-darks"
          ...
          <div class="w-[80%] mx-auto">
            <label for="cpassword" class="dark:text-darks"
            ...
            <vee-field
              ...
              class="border dark:text-darks border-gray-700 block w-full rounded p-1 focus:outline focus:outline-base"
            />
            <ErrorMessage class="text-red-500 text-sm" name="cpassword" />
          </div>
          <div class="w-[80%] mt-3 flex flex-row-reverse gap-2 items-center">
            <label for="tc" class="text-sm dark:text-darks"
              >Agree to <a class="underline text-sm">terms and conditions</a></label
            >
            <vee-field
              type="checkbox"
              name="tc"
              id="tc"
              value="1"
              class="border block w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-lg focus:ring-blue-500"
            />
          </div>
          <div class="text-center -mt-3">
            <ErrorMessage class="text-red-500 text-sm" name="tc" />
          </div>
